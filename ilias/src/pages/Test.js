...
const ParticleText = () => {
  ...
  useEffect(() => {
    ...
    // Environment class handles the Three.js scene, camera, and renderer setup
    class Environment {
    ...
    // CreateParticles class handles the creation and animation of particles
    class CreateParticles {
      ...
      // Setup initial geometry and material
      setup = () => {
      ...
      // Render loop for particles animation
      render = (level) => {
        ...
        if (intersects.length > 0) {
          ...
          for (var i = 0, l = pos.count; i < l; i++) {
            ...
            if (this.buttom) {
              ...
              px -= f * Math.cos(t);
              py -= f * Math.sin(t);
              this.colorChange.setHSL(.55, 1, .34)
              coulors.setXYZ(i, this.colorChange.r, this.colorChange.g, this.colorChange.b)
              coulors.needsUpdate = true;
      ...
      // Create text from font and convert to particles
      createText = () => {
        let thePoints = [];
